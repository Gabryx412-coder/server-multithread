...
// compilazione : g++ -o ./server/tcpServer ./server/tcpServer.cpp
// g++ -pthread -o ./server/tcpServer ./server/tcpServer.cpp (quando ci sono thread usati nel programma)
...
#define SERVER_BACKLOG 1 // numero massimo di connessioni consentite nella coda di attesa del server.
...
int main(int identity, char **argv)
{
    ...
    // creare i thread multipli per gestire le connessioni
    ...
    // forza l'aggancio del socket alla porta 8080 anche se la porta è già in uso
